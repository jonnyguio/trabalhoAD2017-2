...
def deal_event(event):
    ...
    if event.get_type() == EVENT_TYPE_ARRIVAL:
        ...
        new_client = Client( event.get_start_time() )
        ...
        #caso o servidor esteja ocupado, nada acontecerá caso seja o cliente 1, caso seja o cliente 2, ele sofrerá preempção
            ...
            client_running.set_service_time_2( event.get_start_time() - event_end_service.get_start_time() )
    ...
    # o cliente 1 com certeza estará no servidor
        ...
        client = server.pop()
        client.set_end_service_1( event.get_start_time )
        client.set_start_queue_2( event.get_start_time )
        queue2.push(client)
        ...
        client = server.pop()
        client.set_end_service_2( event.get_start_time() )
